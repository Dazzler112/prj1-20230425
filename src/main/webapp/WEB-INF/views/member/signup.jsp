...
<body>
	...
	<div class="row justify-content-center">
		...
		<div class="col-12 col-md-8 col-lg-6">
			<form method="post" >
				<!-- .mb-3*5>(label.form-label[for]+input.fomr-control[name]) -->
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<input type="text" id="inputNickname" class="form-control" name="nickName" value="${member.nickName }"/>
				</div>
				<div class="mb-3">
					<label for="inputEmail" class="form-label">이메일</label>
					<input type="email" id="inputEmail" class="form-control" name="email" value="${member.email }"/>
				</div>
				<div class="mb-3">
