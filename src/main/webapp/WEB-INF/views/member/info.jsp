	...
	<div class="container-lg">
		<div class="row justify-content-center">
			<div class="col-12 col-md-8 col-lg-6">
				...
				<div class="mb-3">
					<label for="" class="form-label">별명</label> <input type="text" class="form-control" value="${member.nickName }" readonly />
				</div>
				<div class="mb-3">
					<label for="" class="form-label">이메일</label> <input type="text" class="form-control" value="${member.email }" readonly />
				</div>
