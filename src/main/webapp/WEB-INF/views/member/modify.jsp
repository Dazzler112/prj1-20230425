			...
			<div class="col-12 col-md-8 col-lg-6">
				...
				<form id="modifyForm" action="/member/modify" method="post">
					...
					<div class="mb-3">
						...
						<div id="passwordCollect" class="d-none form-text text-primary">
						<i class="fa-solid fa-check"></i>
						패스워드가 일치합니다.
						</div>
						<div id="passwordWrong" class="d-none form-text text-danger">
					...
					<button type="button" data-bs-toggle="modal" data-bs-target="#confirmModal" id="updateSubmit" class="btn btn-primary">수정</button>
				</form>
